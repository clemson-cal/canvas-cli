...
`plan.md` at the repo root is the project's planning and task-tracking note. It is version-controlled here and simultaneously appears in the owner's Obsidian vault via a symlink (`~/Work/Obsidian/Projects/canvas-cli.md` → this file).
